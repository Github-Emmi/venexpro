...
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "venexbtc@venexbtc.com")  # your Zoho email address
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD", "a4siJdTwe4KA")  # your Zoho app password
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "venexbtc@venexbtc.com")


# Email recipients
CONTACT_EMAIL = os.getenv("CONTACT_EMAIL", "venexbtc@venexbtc.com")
SUPPORT_EMAIL = os.getenv("SUPPORT_EMAIL", "venexbtc@venexbtc.com")
ADMIN_EMAIL = os.getenv("ADMIN_EMAIL", "venexbtc@venexbtc.com") 
