    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('get_cryptocurrency_display', models.CharField(choices=[('BTC', 'Bitcoin'), ('ETH', 'Ethereum'), ('USDT', 'Tether (USDT)'), ('LTC', 'Litecoin'), ('TRX', 'Tron')], default='', max_length=10)),
                ...
                ('cryptocurrency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transactions', to='venex_app.cryptocurrency')),
